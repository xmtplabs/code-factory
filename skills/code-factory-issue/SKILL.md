...
- **Link the issue** — `push-and-pr.sh` prepends `Resolves ${ISSUE_URL}` to the body automatically
- **Reviewer** — `push-and-pr.sh` always adds `REQUESTER` as a reviewer on the PR
