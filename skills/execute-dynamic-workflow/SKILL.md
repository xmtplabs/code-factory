...
Review read-only in the checkout that contains the work, with clean reviewer
context. Avoid separate review worktrees unless isolation is necessary; record
the reason. Verify the candidate commit and keep the checkout fixed during review.
