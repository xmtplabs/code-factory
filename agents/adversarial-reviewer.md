...
5. **Test honesty.** Do the new tests fail if the behavior breaks? A test that passes against a reverted implementation is not a test.
6. **Preface violations.** Deviations from stated conventions that a maintainer would reject in review.
